...
<script id="source" language="javascript" type="text/javascript">
    ...
    $("#graph").bind("plothover", function (event, pos, item) {
        if (item) {
            ...
            {
                    $("#stats").html(((item.datapoint[1]) * 1000 ).toFixed(1)+"Wh | "+mdate.format("HH:MM ddd, mmm dS, yyyy"));
            }
            else
            {
                    $("#stats").html((item.datapoint[1]).toFixed(2)+"kWh | "+mdate.format("HH:MM ddd, mmm dS, yyyy"));
            }
        }
    });
